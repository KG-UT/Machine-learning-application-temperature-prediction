"""trains a decision tree model, and shows how accurate it is based off its loss"""
...
if __name__ == '__main__':
    ...
    print(get_rmse(model=decision_tree_model, validation_features=data_sets.validation_features,
